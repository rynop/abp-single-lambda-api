...
1. Commit your code and the CI/CD CodePipline will automatically run.  We recommend always checking in your dependencies (aka `node_modules`).  Prevents version issues when working in teams, also prevents deploy issues during github outage.
